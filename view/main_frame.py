...
def on_button_click():
    ...
    result_label.config(text=f"País seleccionado: {selected_country}\nTexto ingresado: {user_input}")


# Crear la ventana principal
ventana = tk.Tk()
ventana.title("Acommodation Finder")
...
# Crear una etiqueta
title_label = tk.Label(ventana, text="Acommodation Finder GUI", font=("Arial", 20))
...
combo_box.set("Selecciona un país")
